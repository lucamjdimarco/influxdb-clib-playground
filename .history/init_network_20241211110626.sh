...
iptables -A INPUT -i $ETH0_INTERFACE -s $CONTROL_IPV4_SUBNET -j ACCEPT  # Permetti traffico in ingresso dalla rete di controllo
iptables -A OUTPUT -o $ETH0_INTERFACE -d $CONTROL_IPV4_SUBNET -j ACCEPT  # Permetti traffico in uscita verso la rete di controllo
